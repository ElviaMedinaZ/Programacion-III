...
public class Ventana extends JFrame{
	...
	public void admin() {
		...
		adminPanel.setBackground(Color.decode("#D2F0F9"));//color al panel
		...
		UsersTag.setForeground(Color.white);//Color letra
		UsersTag.setLocation(350,20);
		UsersTag.setOpaque(true);
		UsersTag.setBackground(Color.pink);//Fondo color
		adminPanel.add(UsersTag);
		
		JLabel TitleWidget = new JLabel("Total de usuarios",0);
		TitleWidget.setBounds(40,120,300,100);
		...
		contentWidget.setBounds(40,80,300,140);
		contentWidget.setFont (new Font ("Microsoft Uighur",Font.BOLD,30));//Cambiar la fuente
		...
		widget.setBackground(Color.pink);
		adminPanel.add(widget);
		
		JButton dowland = new JButton ("Exportar");
		dowland.setBounds(850, 180, 100, 40);
		adminPanel.add(dowland);
		
		JButton addUser = new JButton ("Añadir");
		addUser.setBounds(720, 180,100 , 40);
		adminPanel.add(addUser);
		
		String titles [] = {"No.Control","Nombre","Apellidos","Semestre","Acciones"};
		String tableData [] [] = { {"No.Control","Nombre","Apellidos","Semestre","Acciones"},
									{"No.Control","Nombre","Apellidos","Semestre","Acciones"},
									{"No.Control","Nombre","Apellidos","Semestre","Acciones"},
									{"No.Control","Nombre","Apellidos","Semestre","Acciones"},
									{"No.Control","Nombre","Apellidos","Semestre","Acciones"},
									{"No.Control","Nombre","Apellidos","Semestre","Acciones"},
